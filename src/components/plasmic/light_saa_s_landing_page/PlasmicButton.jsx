...
import sty from "./PlasmicButton.module.css"; // plasmic-import: R5gDzZdVWgSa/css
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__pjG4)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__rgT0)}
                role={"img"}
              />
            ),
